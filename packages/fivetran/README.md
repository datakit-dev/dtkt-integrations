...
The `Fivetran` integration implements:
- `ActionService`
- `EventService`
- `DestinationService`
- `SourceService`
...
<img alt="echo-action demo with VHS" src="./examples/echo-action/vhs.gif" width="800" />
...
You should see an entry appear for the `Fivetran` integration.
...
Refer to the [examples](./examples/README.md) for more detailed examples of how to use the `Fivetran` integration package.
