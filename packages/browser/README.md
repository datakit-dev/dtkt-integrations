...
The `Browser` integration implements:
...
You should see an entry appear for the `Browser` integration.
...
Refer to the [examples](./examples/README.md) for more detailed examples of how to use the `Browser` integration package.
