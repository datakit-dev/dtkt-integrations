...
func (UnimplementedEmailServiceServer) SendEmails(grpc.BidiStreamingServer[SendEmailsRequest, SendEmailsResponse]) error {
	return status.Error(codes.Unimplemented, "method SendEmails not implemented")
}
...
func (UnimplementedEmailServiceServer) SendEmailWithTemplate(context.Context, *SendEmailWithTemplateRequest) (*SendEmailWithTemplateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendEmailWithTemplate not implemented")
}
func (UnimplementedEmailServiceServer) SendEmailsWithTemplate(grpc.BidiStreamingServer[SendEmailsWithTemplateRequest, SendEmailsWithTemplateResponse]) error {
	return status.Error(codes.Unimplemented, "method SendEmailsWithTemplate not implemented")
}
func (UnimplementedEmailServiceServer) SendBatchEmailWithTemplate(context.Context, *SendBatchEmailWithTemplateRequest) (*SendBatchEmailWithTemplateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendBatchEmailWithTemplate not implemented")
}
