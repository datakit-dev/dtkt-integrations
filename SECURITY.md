...
We currently only support the **latest stable release** of an integration. Older versions **do not receive security updates**.

## Reporting a Vulnerability

We take security issues seriously. If you discover a vulnerability in an integration, please follow these steps:

### 1. Responsible Disclosure

- Do not publicly disclose security vulnerabilities.
- Report the issue privately to our security team preferably using [Github Advisories](https://github.com/datakit-dev/dtkt-integrations/security) or by email.
...
To securely use DataKit integrations, follow these best practices:

### 1. Use Official Channels

Only download integrations from official sources like [dtkt.dev](https://dtkt.dev), our [GitHub Releases](https://github.com/datakit-dev/dtkt-integrations/releases), or from our Docker Hub repository.
...
Regularly scan your installed version of the DataKit CLI and integrations for vulnerabilities.
...
### 4. Keep Your Version Updated

Since we currently only support the **latest stable release**, always update an integration before using it.
...
This security stack helps ensure that our artifacts remains safe, reliable, and compliant with industry best practices.
